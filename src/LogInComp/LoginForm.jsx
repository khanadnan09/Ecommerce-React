...
const LoginForm = () => {
    return (
        <LoginContainer>
            ...
            <Heading>Log in to Shopifyplus</Heading>
            <SocialMedia><span><FaGoogle /><FaFacebookF /><FaLinkedinIn /></span>
            <div>Or use email for log in</div>
            </SocialMedia>
            <Form>
                <div>
                    <label htmlFor="email"><HiOutlineMail/>Emial</label>
                    <input type="email" id='email' style={{paddingLeft:"90px"}} />
                </div>
                <div>
                    <label htmlFor="password"><HiOutlineLockClosed/>Password</label>
                    <input type="password" id='password' style={{paddingLeft:"120px",fontSize:"20px",fontWeight:"600"}} />
                </div>
               <span><div>Forgot Password ?</div>
                <button>Log In</button></span> 
            </Form>
        </LoginContainer>
    )
}
